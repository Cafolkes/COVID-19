...
def plot_confirmed(covid_df, folder, min_confirmed_rate=0., min_population=0, req_countries=[]):
    ...
    plt.title('Confirmed cases in countries with more than ' + str(min_confirmed_rate) + '/1000 inhabitant cases (US, Norway, Denmark, Sweden always included)')
...
def plot_deaths(covid_df, folder, min_death_rate=0., min_population=0., req_countries=[]):
    ...
    plt.title('Confirmed deaths in countries with more than ' + str(min_death_rate) + '/1000 inhabitant deaths (US, Norway, Denmark, Sweden always included)')
    plt.legend(loc='upper left')
    plt.grid()
    plt.tight_layout()
